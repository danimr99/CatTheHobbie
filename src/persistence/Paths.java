...
public abstract class Paths {
    ...
    public static String getBoatsDataset(String datasetSize) {
        return getPath(datasetSize, BOATS_L, BOATS_M, BOATS_S, BOATS_XS);
    }

    public static String getSailorsDataset(String datasetSize) {
        return getPath(datasetSize, SAILORS_L, SAILORS_M, SAILORS_S, SAILORS_XS);
    }

    private static String getPath(String datasetSize, String l, String m, String s, String xs) {
        switch (datasetSize) {
            case "L" -> {
                return l;
            }
